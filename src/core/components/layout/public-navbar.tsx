      ...
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  active ? "bg-rose-50 text-[#D47575]" : "text-zinc-600 hover:bg-zinc-50 hover:text-zinc-950",
                )}
              >
                {item.label}
              </Link>
        ...
        <div className="flex items-center gap-2">
          <Link
            ...
            className="hidden h-11 items-center gap-2 rounded-full border border-zinc-200 px-4 text-sm font-bold text-zinc-800 transition hover:border-rose-200 hover:bg-rose-50 sm:inline-flex"
          >
          ...
          <Link
            ...
            target="_blank"
            rel="noreferrer"
            className="hidden h-11 items-center rounded-full bg-[#D47575] px-5 text-sm font-black text-white shadow-lg shadow-rose-900/20 transition hover:-translate-y-0.5 hover:bg-[#bf6060] md:inline-flex"
          >
            Order Now
          </Link>
          <button
