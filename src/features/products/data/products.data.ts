...
export const PRODUCTS: Product[] = [
  {
    ...
    emoji: "🥗",
    imageGradient: "from-green-100 via-lime-100 to-yellow-100",
    badges: ["Best Seller", "Fruit Lovers"],
    nutrition: { calories: 230, sugar: "Balanced", protein: "4g" },
  ...
  },
  {
    ...
    emoji: "🥝",
    imageGradient: "from-green-100 via-green-50 to-white",
  ...
  },
  {
    ...
    nutrition: { calories: 240, sugar: "Controlled", protein: "5g" },
  ...
  },
  {
    ...
    price: 32000,
    image: KAHALA_IMAGES.unsplashBreakfast,
    emoji: "🥭",
    imageGradient: "from-yellow-100 via-orange-100 to-yellow-50",
    badges: ["Tropical", "Fresh Mix"],
    nutrition: { calories: 260, sugar: "Balanced", protein: "4g" },
  ...
  },
  {
    ...
    nutrition: { calories: 190, sugar: "Light", protein: "3g" },
  ...
  },
  {
    ...
    emoji: "🍱",
    imageGradient: "from-lime-100 via-green-100 to-pink-50",
    badges: ["Sharing Pack", "Family"],
    nutrition: { calories: 880, sugar: "Mixed", protein: "22g" },
...
export function getRelatedProducts(productId: string, categorySlug: string) {
  return PRODUCTS.filter(
    (product) => product.id !== productId && product.category === categorySlug,
  ).slice(0, 3);
}
